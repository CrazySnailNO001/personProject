package com.xzh.personalproject.congig.aopLog;

import com.xzh.personalproject.commons.utils.SafeUtils;
...
public class LogAspect {
     ...
     * 业务逻辑方法切入点
     */
    //@Pointcut("execution(* com.xzh.personalproject.service.impl..*(..))")
     ...
     * 调用新浪业务逻辑方法切入点
     */
    @Pointcut("execution(* com.xzh.personalproject.*.services.impl.*ServiceImpl.*(..))")
     ...
     *
     */
    @Pointcut("execution(* com.xzh.personalproject.*.*controllers.*Controller.*(..))")
